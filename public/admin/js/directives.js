angular.module('mean-admin.system').directive('ngEnter', function() {
...
angular.module('mean-admin.system').directive('ngEditable', function() {
    return {
...
angular.module('mean-admin.system').directive('ngEditableParagraph', function() {
    return {
        // can be in-lined or async loaded by xhr
        // or inlined as JS string (using template property)
...
angular.module('mean-admin.system').directive('ngEditableSelect', function() {
    return {
        template: '<span class="editable-wrapper">' + '<span data-ng-hide="edit" data-ng-click="edit=true;value=model;">{{text()}}</span>' + '<select data-ng-model="value" data-ng-show="edit" data-ng-options="option for option in options" data-ng-change="model=value;edit=false;">' + '<option value="">Choose Option</option>' + '</select>' + '</span>',
        scope: {
